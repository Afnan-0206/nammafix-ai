...
const ZONES = [
  {
    ...
    wards: 'Wards 81–86, 149–150 (Whitefield, Bellandur, Varthur, Hoodi, KR Puram)',
  ...
  },
  {
    ...
    wards: 'Wards 174–176, 186–191 (HSR Layout, Begur, Hulimavu, Bilekahalli)',
  ...
  },
  {
    ...
    name: 'East Zone',
    kannada: 'ಪೂರ್ವ ವಲಯ',
    wards: 'Wards 78–80, 88–92, 111–117 (Indiranagar, Halasuru, Cox Town, Shanthinagar)',
  ...
  },
  {
    ...
    name: 'South Zone',
    kannada: 'ದಕ್ಷಿಣ ವಲಯ',
    wards: 'Wards 142–148, 168–172 (Jayanagar, JP Nagar, Basavanagudi, BTM Layout)',
  ...
  },
  {
    ...
    name: 'West Zone',
    kannada: 'ಪಶ್ಚಿಮ ವಲಯ',
    wards: 'Wards 94–101, 120–135 (Malleshwaram, Rajajinagar, Gandhinagar, Chamarajapet)',
  ...
  },
  {
    ...
    kannada: 'ರಾಜರಾಜೇಶ್ವರಿನಗರ ವಲಯ',
    wards: 'Wards 129–131, 159–161 (RR Nagar, Kengeri, Jnana Bharathi, Nayandahalli)',
    aee: 'Sri. B. K. Manjunath, Executive Engineer',
    phone: '080-28601551',
    activeHazards: 8,
    resolvedWeek: 34,
    slaCompliance: '96.1%',
    criticalAlert: 'Kengeri Satellite Town arterial asphalt patch completed',
    status: 'Optimal',
  },
  {
    id: 'yelahanka',
    name: 'Yelahanka Zone',
    kannada: 'ಯಲಹಂಕ ವಲಯ',
    wards: 'Wards 1–10 (Yelahanka New Town, Byatarayanapura, Vidyaranyapura, Kodigehalli)',
    aee: 'Smt. R. Savitha, Joint Commissioner',
    phone: '080-23636671',
    activeHazards: 10,
    resolvedWeek: 40,
    slaCompliance: '95.3%',
    criticalAlert: 'Bellary Road NH-44 feeder service road drainage overhaul',
    status: 'Routine',
  },
  {
    id: 'dasarahalli',
    name: 'Dasarahalli Zone',
    kannada: 'ದಾಸರಹಳ್ಳಿ ವಲಯ',
    wards: 'Wards 11–18 (Peenya Industrial Area, Bagalakunte, T. Dasarahalli, Chokkasandra)',
    aee: 'Sri. C. Venkatesh, AEE Infrastructure',
    phone: '080-28394909',
    activeHazards: 14,
    resolvedWeek: 36,
    slaCompliance: '93.7%',
    criticalAlert: 'Peenya 4th Phase industrial corridor heavy-duty pothole filling',
    status: 'High Activity',
  },
]
